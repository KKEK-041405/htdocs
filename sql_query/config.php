...
mysqli_query($conn,"CREATE TABLE if not exists `mbts`.`transactions` (`Transaction_id` VARCHAR(50) NOT NULL , `Accession_no` VARCHAR(50) NOT NULL , `Title` VARCHAR(50) NOT NULL , `Reciver_pin-no` VARCHAR(50) NOT NULL , `Status` VARCHAR(50) NOT NULL , `Transaction_Position` VARCHAR(50) NOT NULL , `issuance_date` VARCHAR(50) NOT NULL , `Due_date` VARCHAR(50) NOT NULL ) ENGINE = InnoDB;");
